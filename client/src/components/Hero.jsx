...
const Hero = () => {
  ...
  return (
    ...
    >
      {}
      <motion.h1
        className="text-4xl md:text-5xl font-extrabold michroma-regular text-primary mb-6"
      ...
      {}
      <motion.p
        className="max-w-2xl text-lg md:text-xl text-gray-800 mb-10 leading-relaxed"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.form
        ...
        className="w-full max-w-3xl bg-white rounded-full shadow-lg p-4 flex flex-col md:flex-row items-start md:items-center gap-4"
      ...
      >
        ...
        <div className="flex-1 flex flex-col">
          ...
          <select
            ...
            className="w-40 md:w-56 p-3 rounded-full border border-gray-300 bg-white text-primary font-semibold focus:outline-none focus:ring-2 focus:ring-primary transition placeholder-gray-500"
          >
        ...
        <motion.button
          type="submit"
          className="bg-primary text-white px-6 py-3 rounded-full flex items-center gap-2 hover:bg-primary-dull transition"
      ...
      <motion.img
        src={assets.main_car}
        alt="Luxury Car"
        className="mt-12 max-h-80 drop-shadow-2xl"
